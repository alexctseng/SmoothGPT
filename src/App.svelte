...
<div class="fixed top-0 right-0 h-screen flex items-start z-50 transition-all duration-300 ease-in-out"
     style="width: {isPromptLibraryVisible ? '300px' : '40px'};">
  <!-- Toggle button -->
  <button
    class="bg-primary text-white p-2 rounded-l-lg flex items-center justify-center"
  ...
  <div
    class="flex-grow h-full bg-primary overflow-y-auto"
    style="width: {isPromptLibraryVisible ? 'calc(100% - 40px)' : '0px'}; overflow-x: hidden;"
  >
    <PromptLibrary />
  </div>
</div>
